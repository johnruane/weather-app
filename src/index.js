...
export default class WeatherApp extends React.Component {
  ...
  async handleSubmit(id) {
    const URL = `http://api.openweathermap.org/data/2.5/weather?&units=metric&id=${id}&appid=1f2d551b407d5fe41b27a5e4bd5fd3ad`;
      ...
      <div className="weather-container">
        <form className="input-form">
          <div className="input-wrapper">
            ...
            <span className="input-form-submit" type="submit" value="Submit">
